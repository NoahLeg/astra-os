...
class Container {
    ...
    requestAnimationFrame(() => {
      ...
      if (newWidth !== this.width || newHeight !== this.height) {
        ...
        this.children.forEach(child => {
          if (typeof child.setupAsNestedGlass === 'function' && child.isNestedGlass && child.gl_refs.gl) {
  ...
  `
    ...
    this.gl_refs = {
      ...
      warpLoc, edgeIntensityLoc, rimIntensityLoc, baseIntensityLoc, edgeDistanceLoc,
      rimDistanceLoc, baseDistanceLoc, cornerBoostLoc, rippleEffectLoc, tintOpacityLoc, imageLoc,
