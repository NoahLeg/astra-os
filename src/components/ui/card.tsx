...
export function Card({ className, ...props }: HTMLAttributes<HTMLDivElement>) { return <div className={cn("rounded-2xl border bg-card text-card-foreground shadow-[0_18px_60px_-40px_rgba(0,0,0,.65)]", className)} {...props} />; }
