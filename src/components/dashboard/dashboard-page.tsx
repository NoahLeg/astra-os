...
export function DashboardPage() {
  ...
  return (
    <LiquidGlassRoot className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 gap-5">
      <AnimatedBackground className="col-span-full row-span-full -z-10 pointer-events-none" />
      <GlassDecorative shape="circle" preset="vivid" size="sm" className="pointer-events-none" style={{ position: 'absolute', top: '5%', right: '2%', zIndex: 0, opacity: 0.6 }} />
      <GlassDecorative shape="blob" preset="subtle" size="md" className="pointer-events-none" style={{ position: 'absolute', bottom: '10%', left: '-2%', zIndex: 0, opacity: 0.3 }} />

      <GlassCard className="col-span-full overflow-hidden p-5 sm:p-7 lg:p-9">
