      ...
      <div className="grid gap-4 lg:grid-cols-[1fr_.7fr]">
        <Card className="border-primary/20">
          ...
          <CardContent>
            ...
            <div className="mt-5 grid gap-3 sm:grid-cols-3"><div className="rounded-xl border glass p-3"><p className="text-xs text-muted-foreground">Tokens d’entrée</p><p className="mt-1 font-mono font-semibold">{subscription.inputTokensUsed.toLocaleString("fr-FR")}</p><p className="text-[10px] text-muted-foreground">dont {subscription.cachedInputTokensUsed.toLocaleString("fr-FR")} en cache</p></div><div className="rounded-xl border glass p-3"><p className="text-xs text-muted-foreground">Tokens de sortie</p><p className="mt-1 font-mono font-semibold">{subscription.outputTokensUsed.toLocaleString("fr-FR")}</p></div><div className="rounded-xl border glass p-3"><p className="text-xs text-muted-foreground">Coût cumulé réel</p><p className="mt-1 font-mono font-semibold">{usd.format(subscription.totalCostNanoUsd / 1_000_000_000)}</p></div></div>
          </CardContent>
        </Card>
