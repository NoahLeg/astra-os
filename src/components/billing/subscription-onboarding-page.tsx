  ...
  useEffect(() => {
    ...
    void (async () => {
      try {
        ...
        if (cancelled) return;
        if (searchParams.get("checkout") === "cancelled") toast.info("Paiement annulé. Vous pouvez choisir une autre offre ou rester en Starter.");
